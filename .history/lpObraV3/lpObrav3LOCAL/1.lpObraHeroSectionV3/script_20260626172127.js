(function () {
  const ASSET_BASE =
    "https://abcdaconstrucao.my.site.com/resource/lpCadastreSuaObra";
  const MOBILE_HEADER_MQ = "(max-width: 720px)";

  const assets = {
    logo: `${ASSET_BASE}/logo/logo-abc.png`,
    heroBackground: `${ASSET_BASE}/hero/bg-hero-2.jpg`,
  ...
  const bigNumbersData = [
    ...
    },
    {
      ...
      value: "+1.200",
      displayValue: "+",
      description: "cidades com cobertura ABC",
    },
    {
      id: "3",
    ...
    },
    {
      ...
      value: "+11",
      displayValue: "+",
      description: "estados estao com a ABC",
    },
    {
      id: "5",
  ...
  function setAssets() {
    ...
    if (highlightIconEconomia) {
      highlightIconEconomia.src = assets.highlightSuporte;
    }
    ...
    if (highlightIconSuporte) {
      highlightIconSuporte.src = assets.highlightEconomia;
    }
